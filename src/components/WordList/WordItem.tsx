  ...
  return (
    ...
    >
      <div className="flex items-center justify-between space-x-3">
        {/* Checkbox & Word Title (Highest Priority: Full word display, shrink-0) */}
        <div className="flex items-center space-x-2.5 shrink-0 min-w-0">
          ...
          <div className="flex items-center space-x-2 shrink-0">
            <h3 className="font-bold text-slate-800 text-base sm:text-lg tracking-tight shrink-0 whitespace-nowrap">
              {word}
            </h3>
            {isLearned && (
              <span
        ...
        {/* Definition Preview (Flex shrink & truncate when space is tight) */}
        <span
          className={`text-xs font-semibold px-2.5 py-1 rounded-xl truncate min-w-0 max-w-[50%] sm:max-w-[60%] shrink text-right ${
            isSelected
